...
' Your code here...
REM:</RunScriptWithoutWindow>
' this run script will hidden window.
' where "number" end of line is 0 for hide the window while 1 for show the window. 
Dim WinScriptHost
Set WinScriptHost = CreateObject("WScript.Shell")
WinScriptHost.Run """" & "C:\SysinternalsSuite\Custom Batch file\Rammap.bat" & """", 0
